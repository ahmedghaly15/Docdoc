...
part of 'fill_profile_api_service.dart';
...
class _FillProfileApiService implements FillProfileApiService {
  _FillProfileApiService(this._dio, {this.baseUrl, this.errorLogger}) {
